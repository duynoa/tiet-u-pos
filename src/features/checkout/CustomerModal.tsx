    ...
    <AnimatePresence>
      {isOpen && (
        <div key={isOpen ? "open" : "closed"}>
          ...
          >
            <div
              className="flex flex-col gap-8 px-[60px] py-[50px] bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto pointer-events-auto"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[#111] text-2xl md:text-[32px] font-bold capitalize">Nhập Thông tin khách hàng</h2>
              </div>
              ...
              <div className="flex flex-col gap-9">
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M12 2C13.3261 2 14.5979 2.52678 15.5355 3.46447C16.4732 4.40215 17 5.67392 17 7C17 8.32608 16.4732 9.59785 15.5355 10.5355C14.5979 11.4732 13.3261 12 12 12C10.6739 12 9.40215 11.4732 8.46447 10.5355C7.52678 9.59785 7 8.32608 7 7C7 5.67392 7.52678 4.40215 8.46447 3.46447C9.40215 2.52678 10.6739 2 12 2ZM12 14.5C17.525 14.5 22 16.7375 22 19.5V22H2V19.5C2 16.7375 6.475 14.5 12 14.5Z" fill="#555555" />
                      </svg>
                      <label className="text-[#262626] text-lg md:text-2xl font-medium">
                        Tên khách hàng
                      </label>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 md:py-4 rounded-lg border text-lg md:text-2xl text-[#111] placeholder:text-[#B0B0B0] focus:outline-none focus:border-[#CB2527] transition-colors ${nameError ? "border-[#CB2527] bg-red-50" : "border-[#C7C7CC]"}`}
                    />
                    {nameError && (
                      <p className="text-[#CB2527] text-sm md:text-lg font-medium">{nameError}</p>
                    )}
                  </div>
                </div>
