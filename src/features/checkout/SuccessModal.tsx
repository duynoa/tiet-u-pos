...
const SuccessModal = ({ isOpen, onClose, customerName, totalPrice }: SuccessModalProps) => {
            ...
            >
              ...
              <div className="w-full flex flex-col items-center gap-8">
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-[#555] text-base font-semibold">24/12/2019, 10:12</p>
                </div>
