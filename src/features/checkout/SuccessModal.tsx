              ...
              <div className="w-full flex flex-col items-center gap-8">
                ...
                <div className="flex gap-4 w-full">
                  ...
                  <button
                    ...
                    disabled={!billData || isPrinting}
                    className={`flex items-center justify-center gap-2 w-full p-4 rounded-2xl border-2 text-xl md:text-[32px] font-semibold cursor-pointer transition-colors ${!billData || isPrinting ? "border-[#959DA9] bg-[#959DA9] text-white" : "border-[#CB2527] bg-[#CB2527] text-white hover:bg-[#A81F21] hover:border-[#A81F21]"}`}
                  >
                    {isPrinting ? (
                      <>
                        <svg className="animate-spin" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none">
